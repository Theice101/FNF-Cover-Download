...
function onCreate()
	...
	addCharacterToList('fleetway', 'boyfriend', 'BOYFRIENDnew', 'BOYFRIENDnewer', 'BOYFRIENDold')
	precacheSound('stat')
	precacheImage('BOYFRIENDnew', 'BOYFRIENDnewer', 'BOYFRIENDold')
...
function onStepHit()
	...
	if curStep == 256 or curStep == 1024 or curStep == 1279 or curStep == 1300 or curStep  == 1408 or curStep == 1926 or curStep == 1946 then
		fleetOFF()
	end
	if curStep == 128 or curStep == 640 or curStep == 1154 or curStep == 1176 or curStep == 1792 or curStep == 1940 or curStep == 1960 then
		fleetON2()
	end
end
...
function fleetON()
	...
	playSound('stat', 0.3)
	triggerEvent('Change Character', 0, 'BOYFRIENDnewer')
end
...
function fleetON2()
	...
	doTweenAlpha('fleetON', 'fx', 0, 1, 'linear')
	playSound('stat', 0.3)
	triggerEvent('Change Character', 0, 'BOYFRIENDnew')
end
...
function fleetOFF()
	...
	doTweenAlpha('fleetON', 'fx', 0, 1, 'linear')
	playSound('stat', 0.3)
	triggerEvent('Change Character', 0, 'BOYFRIENDold')
end
